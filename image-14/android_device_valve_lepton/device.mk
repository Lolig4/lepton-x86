...
PRODUCT_PACKAGES += cmd_real vendor_manifest.xml system_manifest.xml manifest.xml
...
PRODUCT_PACKAGES_REMOVE += Bluetooth

PRODUCT_PROPERTY_OVERRIDES += \
    persist.bluetooth.enable=false

PRODUCT_PRODUCT_PROPERTIES+= \
    ro.adb.secure=0 \
    ro.debuggable=1

PRODUCT_PACKAGES += com.android.permission

# Disable Bluetooth packages
PRODUCT_PACKAGES -= Bluetooth
PRODUCT_PACKAGES -= BluetoothMidiService
PRODUCT_PACKAGES -= com.android.bluetooth

PRODUCT_PACKAGES += strace
PRODUCT_PACKAGES += gdbserver
