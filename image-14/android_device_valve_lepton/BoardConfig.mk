...
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 1610612736 # 1.5GB (last actual build size: 1.2GB)
BOARD_VENDORIMAGE_PARTITION_SIZE := 83886080  # 80MB (last actual build size: 40MB)
